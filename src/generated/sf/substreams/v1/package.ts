...
export interface Package {
     ...
     *
     * @generated from protobuf field: string network = 9;
     */
    network: string;
    /**
     * @generated from protobuf field: google.protobuf.Any sink_config = 10;
     */
    sinkConfig?: Any;
    /**
     * @generated from protobuf field: string sink_module = 11;
     */
    sinkModule: string;
}
/**
...
class Package$Type extends MessageType<Package> {
    ...
    create(value?: PartialMessage<Package>): Package {
        const message = { protoFiles: [], version: "0", moduleMeta: [], packageMeta: [], network: "", sinkModule: "" };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated sf.substreams.v1.PackageMetadata package_meta */ 8:
                    ...
                    break;
                case /* string network */ 9:
                    message.network = reader.string();
                    break;
                case /* google.protobuf.Any sink_config */ 10:
                    message.sinkConfig = Any.internalBinaryRead(reader, reader.uint32(), options, message.sinkConfig);
                    break;
                case /* string sink_module */ 11:
    ...
    internalBinaryWrite(message: Package, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string network = 9; */
        if (message.network !== "")
            writer.tag(9, WireType.LengthDelimited).string(message.network);
        /* google.protobuf.Any sink_config = 10; */
        if (message.sinkConfig)
            Any.internalBinaryWrite(message.sinkConfig, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* string sink_module = 11; */
        if (message.sinkModule !== "")
            writer.tag(11, WireType.LengthDelimited).string(message.sinkModule);
