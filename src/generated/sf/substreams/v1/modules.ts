...
export interface Module_Input {
    ...
    input: {
        ...
        oneofKind: "params";
        /**
         * @generated from protobuf field: sf.substreams.v1.Module.Input.Params params = 4;
         */
        params: Module_Input_Params;
    } | {
        oneofKind: undefined;
    };
}
...
/**
 * @generated from protobuf message sf.substreams.v1.Module.Input.Params
 */
export interface Module_Input_Params {
    /**
...
class Module_Input$Type extends MessageType<Module_Input> {
    constructor() {
        super("sf.substreams.v1.Module.Input", [
            ...
            { no: 4, name: "params", kind: "message", oneof: "input", T: () => Module_Input_Params }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* sf.substreams.v1.Module.Input.Store store */ 3:
                    ...
                    break;
                case /* sf.substreams.v1.Module.Input.Params params */ 4:
                    message.input = {
                        oneofKind: "params",
                        params: Module_Input_Params.internalBinaryRead(reader, reader.uint32(), options, (message.input as any).params)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Module_Input, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* sf.substreams.v1.Module.Input.Params params = 4; */
        if (message.input.oneofKind === "params")
            Module_Input_Params.internalBinaryWrite(message.input.params, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class Module_Input_Params$Type extends MessageType<Module_Input_Params> {
    constructor() {
        super("sf.substreams.v1.Module.Input.Params", [
            { no: 1, name: "value", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<Module_Input_Params>): Module_Input_Params {
        const message = { value: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<Module_Input_Params>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Module_Input_Params): Module_Input_Params {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: Module_Input_Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string value = 1; */
        if (message.value !== "")
...
/**
 * @generated MessageType for protobuf message sf.substreams.v1.Module.Input.Params
 */
export const Module_Input_Params = new Module_Input_Params$Type();
// @generated message type with reflection information, may provide speed optimized methods
